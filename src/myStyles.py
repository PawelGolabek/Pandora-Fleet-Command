...
def loadStyles(root,s):
  ...
  s.configure('Red.TCheckbutton',foreground = "#bfbfbf", background = '#202020',font= ('Calibri 12 normal'))
  s.map('Disabled.TCheckbutton', foreground=[('disabled', '#4F4F4F')], background=[('disabled', '#202020')], lightcolor=[('disabled', "#000000")], darkcolor=[('disabled', "#000000")])
  s.configure('Grey.TLabel', background='#202020',foreground = "#EFEFEF",justify='center',font= ('Calibri 12 normal'))
  s.configure("Green.TLabel", foreground = 'green', background = '#202020',justify='center',font= ('Calibri 12 normal'))
  s.configure("Red.TLabel", foreground = 'red', background = '#202020',justify='center',font= ('Calibri 12 normal'))
  s.configure("Yellow.TLabel", foreground = 'yellow', background = '#202020',justify='center',font= ('Calibri 12 normal'))
  s.configure("Blue.TLabel", foreground = '#4582ec', background = '#202020',justify='center',font= ('Calibri 12 normal'))
