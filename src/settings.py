...
class global_var():
    def __init__(self,config,root):
        ...
        self.fogOfWar = True
        self.gameSpeed = 1
        self.turnLength = 1000
        self.zoom = 1
        self.shieldRegen = 1
        self.shieldMaxState = 4000
        self.respawns = 0
        self.enemyRespawns = 0
        self.audioOn = False            # audio flag. Should be on if sounds in final game
        # GAME DATA
        self.t1 = []
        self.labelCounter = 0
...
class ui_metrics():
    ...
    systemScalesMarginTop = 30
    systemScalesOffsetY = 145
    systemScalesWidthOffset = 306
    systemScalesLFHeight = 340
    systemProgressbarsHeightOffset = 60
    systemsLFWidth = 400
    systemScalesLFWidth = systemsLFWidth
    systemScaleWidth = 120
    pausedLWidth = 100
    pausedLHeight = 100
    canvasX = 440
    canvasY = 10
    systemsLFY = canvasY + canvasHeight + 5
    shipDataX = canvasX
    ...
    objectivesLFHeight = systemScalesLFHeight - (objectivesLFY - systemsLFY)
