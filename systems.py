...
############################## SYSTEMS #############################################
class system(object):
    def __init__(self,name = "system",minEnergy=0,maxEnergy=5,energy=0, maxCooldown = 200, cooldown = 0, mass = 10):
        self.name = name
...
class none(system):
    def __init__ (self,name = "noneSystem",minEnergy=0,maxEnergy=0,energy=0, maxCooldown = 0, cooldown = 0, mass = 0):
...
class throttleBrake1(system):
    def __init__ (self,name = "Throttle Brake I",minEnergy=0,maxEnergy=3,energy=0, maxCooldown = 300, cooldown = 0, mass = 10):
...
class hullRepairSystem1(system):
    def __init__ (self,name = "Anti Missle System I",minEnergy=0,maxEnergy=3,energy=0, maxCooldown = 300, cooldown = 0, mass = 10):
...
class hullRepairSystem2(system):
    def __init__ (self,name = "Anti Missle System II",minEnergy=0,maxEnergy=10,energy=0, maxCooldown = 200, cooldown = 0, mass = 20):
...
class antiMissleSystem1(system):
    def __init__ (self,name = "Anti Missle System II",minEnergy=0,maxEnergy=10,energy=0, maxCooldown = 1500, cooldown = 0, mass = 10):
...
class antiMissleSystem2(system):
    def __init__ (self,name = "Anti Missle System II",minEnergy=0,maxEnergy=10,energy=0, maxCooldown = 1200, cooldown = 0, mass = 25):
...
class type1aCannon1(system):
    def __init__ (self,name = "Type1a Cannon I",minEnergy=0,maxEnergy=3,energy=0, maxCooldown = 1000, cooldown = 0, mass = 10):
...
class type2aCannon1(system):
    def __init__ (self,name = "Type2a Cannon I",minEnergy=0,maxEnergy=6,energy=0, maxCooldown = 300, cooldown = 0, mass = 15):
...
class type3aCannon1(system):
    def __init__ (self,name = "Type3a Cannon I",minEnergy=0,maxEnergy=3,energy=0, maxCooldown = 1700, cooldown = 0, mass = 30):
...
class gattlingLaser1(system):
    def __init__ (self,name = "Gattling Laser I",minEnergy=0,maxEnergy=9,energy=0, maxCooldown = 60, cooldown = 0, mass = 10):
...
class gattlingLaser2(system):
    def __init__ (self,name = "Gattling Laser II",minEnergy=2,maxEnergy=8,energy=0, maxCooldown = 40, cooldown = 0, mass = 15):
...
class highEnergyLaser1(system):
    def __init__ (self,name = "High Energy Laser I",minEnergy=4,maxEnergy=8,energy=0, maxCooldown = 800, cooldown = 0, mass = 10):
...
class kinetic1(system):
    def __init__ (self,name = "Kinetic cannon I",minEnergy=0,maxEnergy=7,energy=0,maxCooldown=100,cooldown=0,mass=30):
...
def shoot(var,system,ship,ammunitionType,ships,uiMetrics,offsetX=0,offsetY=0):
    ...
    for ship2 in ships:
        if(not ship.owner == ship2.owner): # add teams if needed            for element in list:
            ...
            list.append(ghostShip)
            for element in list:
                distance2 = pow(element.x-ship2.xPos, 2)+pow(element.y-ship2.yPos, 2)
